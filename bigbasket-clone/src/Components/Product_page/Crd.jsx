...
const Crd = (props) => {
  return (
    ...
    <div className='saif'>
        ...
        <h5 className='card_off' style={{textAlign:"end"}}>Get of {props.OFF}% </h5>
        <div style={{height:"250px"}}>
         ...
         <div className='card_info'>
            ...
            <button style={{marginLeft:"65px", backgroundColor: "rgb(219, 219, 27)",
  borderRadius:"11%"}}>Add Cart</button>
            </div>
            </div>
    </div>
